...
<head>
    ...
    <title>Mad Colors | Message</title>
                    ...
                    <div class="col-12 col-lg-5 px-0">
                        <div class="bg-white">
                            <div class="bg-light px-4 py-2">
                                <div class="col-12">
                                    <h5 class="mb-0 py-1 fw-bold text-primary">Recents</h5>
                                </div>
                                <div class="col-12">
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        ...
                                        FROM `chat` WHERE `from`='" . $mail . "' ORDER BY `date_time` DESC");
                                            ...
                                            ?>
                                                ...
                                                <div class="mt-1 sent">
                                                    <div class="list-group rounded-0" onclick="viewMessages('<?php echo $msg_data['from']; ?>');">
                                                        <a href="#" class="list-group-item list-group-item-action text-black rounded-0 bg-primary">
                                                            <div class="media">
                                                                <?php
