...
<head>
    ...
    <title>Mad Colors | Update Product</title>
                    ...
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-12 text-center">
                                <h2 class="h2 text-danger fw-bold">Update My Products</h2>
                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <select class="form-select text-center" disabled>
                                                    ...
                                                    $category_rs = Database::search("SELECT * FROM `maincategory` WHERE `id`='".$product["maincategory_id"]."'");
                                    ...
                                    <div class="col-12 col-lg-4 border-end border-success">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <select class="form-select text-center" disabled>
                                                <?php 
                                                $category_rs =Database::search("SELECT * FROM `category` WHERE `id` ");
                                                $category_data = $category_rs->fetch_assoc();
                                                ?>   
                                                    <option><?php echo $category_data["name"] ?></option>
                                                </select>
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="offset-lg-3 col-12 col-lg-6 d-grid mt-3">
                                                ...
                                                <label for="imageuploader" class="col-12 btn btn-danger" onclick="changeProductImage();">Upload Images</label>
                                            </div>
                                        </div>
                                    </div>
