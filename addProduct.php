...
<head>
    ...
    <title>Mad Colors | Add Products</title>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-4 border-end border-success">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <label class="form-label fw-bold" style="font-size: 20px;">Select Product Main Category</label>
                                        </div>

                                        <div class="col-12">
                                            <select class="form-select text-center" id="maincategory" onchange="load_brand();">
                                                <option value="0">Select Main Category</option>
                                                <?php

                                                $maincategory_rs = Database::search("SELECT * FROM `maincategory`");
                                                $maincategory_num = $maincategory_rs->num_rows;

                                                for ($x = 0; $x < $maincategory_num; $x++) {
                                                    $maincategory_data = $maincategory_rs->fetch_assoc();
                                                ?>
                                                    <option value="<?php echo $maincategory_data["id"]; ?>"><?php echo $maincategory_data["name"]; ?></option>
                                                <?php
                                                }
                                ...
                                <div class="col-12">
                                    ...
                                    <label class="form-label">We are taking 5% product from price from every product as a service charge.</label>
                                </div>
