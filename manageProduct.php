...
<head>
    ...
    <title>Mad Colors | Manage Products | Admins</title>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <span class="fs-5"><?php echo $user_data["fname"] . " " . $user_data["fname"]; ?></span><br />
                ...
                <div class="row gap-1 justify-content-center">
                    ...
                    <div class="col-12 col-lg-3 border border-danger rounded" style="height: 50px;">
                        <div class="row">
                            ...
                            <div class="col-4 border-start border-secondary text-center mt-2 mb-2">
                                <label class=" form-label fs-4"><i class="bi bi-plus-square-fill text-warning" onclick="addCategoryModal();"></i></label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal" tabindex="-1" id="addCategoryVerificationModal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                            <button type="button" class="btn btn-primary" onclick="saveCategory();">Verifiy & Save</button>
                        </div>
                    </div>
                </div>
            </div>
