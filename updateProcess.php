...
if(isset($_SESSION["p"])){
    ...
    $allwed_img_extentions = array("image/jpg","image/png","image/svg+xml");
    ...
    if($length <=3 && $length > 0){
        ...
        for($x = 0;$x < $length; $x++){
            if(isset($_FILES["i".$x])){
                ...
                if(in_array($file_type,$allwed_img_extentions)){
                    ...
                    if($file_type == "image/jpg"){
                     ...
                     $file_name = "resources//Dresses//".$title."_".$x."_".uniqid().$new_img_extention;
