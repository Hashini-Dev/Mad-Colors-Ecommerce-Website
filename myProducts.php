...
?>
    ...
    <head>
        ...
        <title>Mad Colors | My Products</title>
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="row">
                                <div class="col-12 col-lg-4 mt-1 mb-1 text-center">
                                    ...
                                    ?>
                                        <img src="resources/profile_image/newuser.svg" width="90px" height="90px" class="rounded-circle" />
                                    <?php
                                    }
                                    ?>
                        ...
                        <div class="col-12 col-lg-8">
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-2 mx-2 mb-2 my-lg-4 mx-lg-0 d-grid">
                                    <button class="btn btn-secondary fw-bold" onclick="window.location='addProduct.php'">Add Product</button>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="col-12 text-center mt-3 mb-3">
                                            <div class="row g-2">
                                                <div class="col-12 col-lg-6 d-grid">
                                                    <button class="btn btn-danger fw-bold" onclick="sort1(0);">Sort</button>
                                                </div>
                                                <div class="col-12 col-lg-6 d-grid">
                                            ...
                                            <div class="card mb-3 mt-3 col-12 col-lg-6">
                                                <div class="row">
                                                    <div class="col-md-4 mt-4">
                                                        ...
                                                        ?>
                                                        <img src="<?php echo $product_img_data["code"]; ?>" class="img-fluid rounded-start" style="height: 120px;" />
                                                    </div>
                                                    <div class="col-md-8">
                                                        <div class="card-body">
